<x-admin-layout>
    ...
    <div x-data="{ imagePreview: null }" class="h-full overflow-y-auto">
        <!-- Header -->
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
